...
-- 강좌시간분류
DROP TABLE IF EXISTS class_time RESTRICT;
...
ALTER TABLE creator
  MODIFY COLUMN creator_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '크리에이터번호';
...
ALTER TABLE users
  MODIFY COLUMN users_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '이용자번호';
...
CREATE TABLE class (
  ...
  start_date    TIME         NOT NULL COMMENT '시작일', -- 시작일
  ...
  in_out_ex     CHAR(1)      NULL     COMMENT '실내외운동' -- 실내외운동
)
COMMENT '강좌';
...
ALTER TABLE myclass_ask
  MODIFY COLUMN COL INTEGER NOT NULL AUTO_INCREMENT COMMENT '강좌문의번호';
...
CREATE TABLE payment (
  ...
  myclass_list_no INTEGER     NULL     COMMENT '강좌신청자번호', -- 강좌신청자번호
  coupon_no       INTEGER     NOT NULL COMMENT '쿠폰번호', -- 쿠폰번호
...
ALTER TABLE class_image
  MODIFY COLUMN class_image_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '강좌이미지번호';
...
CREATE TABLE member_type (
  member_type_no INTEGER NOT NULL COMMENT '회원유형번호', -- 회원유형번호
  member_type    CHAR(1) NOT NULL COMMENT '회원유형' -- 회원유형
)
COMMENT '회원유형';
...
CREATE TABLE myclass_list (
  myclass_list_no INTEGER      NOT NULL COMMENT '강좌신청자번호', -- 강좌신청자번호
  users_no        INTEGER      NOT NULL COMMENT '이용자번호', -- 이용자번호
  class_time_no   INTEGER      NULL     COMMENT '강좌시간분류번호', -- 강좌시간분류번호
...
ALTER TABLE myclass_list
  ADD CONSTRAINT PK_myclass_list -- 강좌신청자 기본키
    PRIMARY KEY (
      myclass_list_no -- 강좌신청자번호
    );

-- 강좌신청자 유니크 인덱스
CREATE UNIQUE INDEX UIX_myclass_list
  ON myclass_list ( -- 강좌신청자
    class_time_no ASC, -- 강좌시간분류번호
    users_no ASC       -- 이용자번호
  );

ALTER TABLE myclass_list
  MODIFY COLUMN myclass_list_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '강좌신청자번호';
...
CREATE TABLE class_time (
  class_time_no INTEGER NOT NULL COMMENT '강좌시간분류번호', -- 강좌시간분류번호
  class_no      INTEGER NOT NULL COMMENT '강좌번호', -- 강좌번호
...
ALTER TABLE class_time
  ADD CONSTRAINT PK_class_time -- 강좌시간분류 기본키
    PRIMARY KEY (
      class_time_no -- 강좌시간분류번호
    );

-- 강좌시간분류 유니크 인덱스
CREATE UNIQUE INDEX UIX_class_time
  ON class_time ( -- 강좌시간분류
    class_no ASC -- 강좌번호
  );

-- 강좌시간분류 유니크 인덱스2
CREATE UNIQUE INDEX UIX_class_time2
  ON class_time ( -- 강좌시간분류
    class_no ASC,   -- 강좌번호
    start_time ASC, -- 시작시간
    end_time ASC    -- 종료시간
...
-- 강좌신청자
ALTER TABLE myclass_list
  ADD CONSTRAINT FK_class_time_TO_myclass_list -- 강좌시간분류 -> 강좌신청자
    FOREIGN KEY (
      class_time_no -- 강좌시간분류번호
    )
    REFERENCES class_time ( -- 강좌시간분류
      class_time_no -- 강좌시간분류번호
    );
...
-- 강좌시간분류
ALTER TABLE class_time
  ADD CONSTRAINT FK_class_TO_class_time -- 강좌 -> 강좌시간분류
    FOREIGN KEY (
      class_no -- 강좌번호
    )
    REFERENCES class ( -- 강좌
