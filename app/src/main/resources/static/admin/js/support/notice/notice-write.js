      ...
      imgTarget.on('change', function(){
          ...
          if(window.FileReader){
              ...
              for(var i=0; i<$(this)[0].files.length; i++){
                if (!$(this)[0].files[i].type.match(/image\//)) return;
                var reader = new FileReader();
                reader.onload = function(e){
                    console.log(e.target)
                    var src = e.target.result;   
                    console.log(src);               
                    parent.prepend('<div class="upload-display"><div class="upload-thumb-wrap"><img src="'+src+'" class="upload-thumb" style="height:50px;" ></div></div>');
                }
