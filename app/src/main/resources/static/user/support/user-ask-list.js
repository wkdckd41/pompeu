// var memberNo = 5; // memberNo가 3인 전체조회를 하기 위해서 미리 선언해줌
...
function selectNoticeList() { // 함수 호출부에서 전달 받은 데이터를 가지고 조회를 하기위한 함수 선언부
    ...
    /*
    fetch(`/notice/list?memberNo=${memberNo}`)
    .then(function(response) {
      return response.json();
    })
