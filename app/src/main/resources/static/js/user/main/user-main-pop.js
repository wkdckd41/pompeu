    ...
    popBox[0] = document.getElementById("pop-box-0");
    ...
    popBox[1] = document.getElementById("pop-box-1");
    ...
    popBox[2] = document.getElementById("pop-box-2");
    ...
    popBox[3] = document.getElementById("pop-box-3");
    ...
    popBox[4] = document.getElementById("pop-box-4");
      ...
      console.log(result);
        ...
        for(i=0; i < 6; i++) {
          ...
          popImg[i].innerHTML = `<img src="/userMain/image?filename=${result[i].image}" width="350px" height="210px">`;
      	  ...
      	  popBox[i].dataset.value = result[i].lNo;
...
//  location.href = '/user/lecture/lecture-detail.html?no='+event.currentTarget.dataset.value;
//}
