$(document).ready(function () {
    ...
    .then(function (result) {
        ...
        for (var i = 0; i < result.fnames.length; i++) {
            ...
            str += `<span class="label label-success"><a href="/notice/fileDownLoad?orgFile=${result.fnames[i].orgFile}&realFile=${result.fnames[i].realFile}" >${result.fnames[i].orgFile}</a></span>&nbsp`
